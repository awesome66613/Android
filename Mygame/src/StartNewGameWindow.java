...
public class StartNewGameWindow extends JFrame {
    ...
    private static final String STR_WIN_LEN = "Условия выигрыша: ";
    private static final String STR_FILED_SIZE = "Установите размер: ";

    private JRadioButton jrbHumVsAi = new JRadioButton("Игрок vs ИИ", true);
    private JRadioButton jrbHumVsHum = new JRadioButton("Игрок vs Игрок");
